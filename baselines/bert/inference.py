...
def main():
    if pollution is None:  # normal inference
        dataset = MyDataset(f'../../datasets/{dataset_name}.json')
    else:
        dataset = MyDataset(f'../../attack/polluted_datasets/{dataset_name}_{pollution}.json')
    acc, f1 = [], []
    for _ in range(10):
