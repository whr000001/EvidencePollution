...
import json
from model import MyModelWithoutComments
...
def main():
    ...
    for _ in range(10):
        ...
        model = MyModelWithoutComments(num_class=loader.dataset.num_class).to(device)
        checkpoint_dir = f'checkpoints/{dataset_name}_{_}_without_comments'
