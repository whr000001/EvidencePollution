...
class HypPostEnc(nn.Module):
    def __init__(self, word_hidden_size, sent_hidden_size, num_classes, embedding_matrix, device):
        ...
        self.sent_att_net = H_SentAttNet(sent_hidden_size, word_hidden_size, num_classes, True)
